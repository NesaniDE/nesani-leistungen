...
export const landingPages: LandingPage[] = [
  {
    slug: "websites",
    metaTitle: "Websites, die verkaufen",
    metaDescription:
    ...
    hero: {
      eyebrow: "Landingpage · Websites",
      headingLines: ["Websites,", "die verkaufen."],
      subline:
        "Modern, schnell und strategisch aufgebaut – für Unternehmen, die online professionell auftreten und mehr Anfragen gewinnen wollen.",
    ...
    stats: [
      ...
      { big: "1:1", label: "Direkter Kontakt" },
      { big: "2–3×", label: "Performance" },
    ],
    features: {
      ...
      moreInfoHref: "/leistungen/websites",
    },
    checklist: {
      eyebrow: "Kostenlos",
      headingLines: ["Die Website-", "Checkliste", "zum Mitnehmen."],
      body: "Eine kompakte Checkliste für Websites, die professionell wirken und Anfragen bringen. Zwei Minuten Lesezeit, klare Prüfpunkte, sofort anwendbar.",
      formSource: "lp-websites",
      ctaLabel: "Checkliste anfordern",
      sideTitle: "Direkt-Anfrage",
      sideBody: "E-Mail eintragen – wir schicken Ihnen die Checkliste zu.",
    },
    finalCta: {
      heading: "Bereit für eine Website, die mehr kann als nur gut aussehen?",
...

  {
    ...
    checklist: {
      ...
      ctaLabel: "Checkliste anfordern",
      sideTitle: "Direkt-Anfrage",
      sideBody: "E-Mail eintragen – wir schicken Ihnen die Workflow-Checkliste zu.",
    },
    finalCta: {
...

  {
    ...
    checklist: {
      ...
      ctaLabel: "Checkliste anfordern",
      sideTitle: "Direkt-Anfrage",
      sideBody: "E-Mail eintragen – wir schicken Ihnen die Agenten-Checkliste zu.",
    },
    finalCta: {
...

  {
    ...
    checklist: {
      ...
      ctaLabel: "Checkliste anfordern",
      sideTitle: "Direkt-Anfrage",
      sideBody: "E-Mail eintragen – wir schicken Ihnen die Markenstimm-Checkliste zu.",
    },
    finalCta: {
...

  {
    ...
    checklist: {
      ...
      ctaLabel: "Checkliste anfordern",
      sideTitle: "Direkt-Anfrage",
      sideBody: "E-Mail eintragen – wir schicken Ihnen die Assistenten-Checkliste zu.",
    },
    finalCta: {
...

  {
    ...
    checklist: {
      ...
      ctaLabel: "Checkliste anfordern",
      sideTitle: "Direkt-Anfrage",
      sideBody: "E-Mail eintragen – wir schicken Ihnen die Architektur-Checkliste zu.",
    },
    finalCta: {
...
export const landingPageSlugs = landingPages.map((lp) => lp.slug);
